...
class AuthenService {
    login () {
        ...
        window.location = `${process.env.VUE_APP_API_BASE_URL}/oauth/authorize?client_id=${process.env.VUE_APP_CLIENT_ID}&redirect_uri=${process.env.VUE_APP_REDIRECT_URI}&response_type=code&scope=&state=${state}`
    }
